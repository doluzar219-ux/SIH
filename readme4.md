...
1. [What is ForensiQ?](#-what-is-forensiq)
2. [Live Architecture](#-live-architecture)
3. [All 6 Modules Explained](#-all-6-modules-explained)
4. [Full Backend API Reference](#-full-backend-api-reference)
5. [Frontend Component Guide](#-frontend-component-guide)
6. [Backend Modules Deep Dive](#-backend-modules-deep-dive)
7. [Database & Audit Chain](#-database--audit-chain)
8. [Getting Started](#-getting-started)
9. [Environment Variables](#-environment-variables)
10. [Tech Stack](#-tech-stack)
11. [Security Standards Compliance](#-security-standards-compliance)
